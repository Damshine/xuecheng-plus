package com.mrs.xuecheng.orders.api;
...
//        alipayRequest.setReturnUrl("http://domain.com/CallBack/return_url.jsp");
        alipayRequest.setNotifyUrl("http://3vsks7.natappfree.cc/orders/paynotifytest");//在公共参数中设置回跳和通知地址
        alipayRequest.setBizContent("{" +
                "    \"out_trade_no\":\"2022101000101010018\"," +
                "    \"total_amount\":0.1," +
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(qrCodeUtil.createQRCode("http://192.168.63.155:63030/orders/alipaytest?payNo=%s", 200, 200));
    }
