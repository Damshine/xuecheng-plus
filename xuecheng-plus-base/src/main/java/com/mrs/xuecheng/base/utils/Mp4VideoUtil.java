...
public class Mp4VideoUtil extends VideoUtil {
    ...
    String ffmpeg_path = "D:\\下载文件\\ffmpeg";//ffmpeg的安装位置
    String video_path = "D:\\下载文件\\商城项目.avi";
    String mp4_name = "商城项目.mp4";
    String mp4folder_path = "D:\\下载文件\\1\\商城项目.mp4";
...
//        Boolean check_video_time = this.check_video_time(video_path, mp4folder_path + mp4_name);
    ...
    public static void main(String[] args) throws IOException {
        ...
        String mp4_name = "商城项目.mp4";
        //转换后mp4文件的路径
        String mp4_path = "D:\\下载文件\\1\\商城项目.mp4";
        //创建工具类对象
